...
const CardInfo = ({
    ...
    return (
        <div className="fixed right-10 bottom-14 h-[780px] w-[300px] bg-[#500000] shadow-2xl rounded-2xl p-5 z-50 overflow-hidden md:h-[600px] sm:h-[500px] sm:w-[250px] lg:h-[780px] lg:w-[300px]">
